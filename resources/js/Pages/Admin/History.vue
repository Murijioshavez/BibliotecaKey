...
function submitSearch(event) {
    if (event.key === 'Enter') {
        ...
        window.location.href = `/admin/loans/history${
            query ? `?search=${query}` : ''
        }`
    }
}
...
<template>
    <AuthenticatedLayout>
        <div
            class="mt-10 max-w-7xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg"
        >
            <h1
                class="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100 tracking-wide"
            >
            ...
            <!-- Tabla -->
            <div
                class="overflow-x-auto rounded-md border border-gray-300 dark:border-gray-700"
            >
                <table class="min-w-full table-auto border-collapse">
                    <thead class="bg-gray-100 dark:bg-gray-700">
                        <tr>
                            <th
                                class="p-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-200 border-b border-gray-300 dark:border-gray-600"
                            >
                                Libro
                            </th>
                    ...
                    <tbody>
                        ...
                        >
                            <td
                                class="p-3 border-b border-gray-300 dark:border-gray-600"
                            >
                            ...
                            <td
                                class="p-3 border-b border-gray-300 dark:border-gray-600 capitalize"
                            >
                                {{ loan.status }}
                            </td>
