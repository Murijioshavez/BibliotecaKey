    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
      <nav class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="flex">
              ...
              >
                ...
                <NavLink :href="route('books.index')" :active="route().current('books.index')"
                  >Catalogo</NavLink
                >
                <NavLink :href="route('admin.loans')" :active="route().current('admin.loans')"
                  >Reservas</NavLink
                >
        ...
        <div
          ...
          class="sm:hidden"
        >
          <div v-if="$page.props.auth.user.role === 'admin'" class="space-y-1 pb-3 pt-2">
            <ResponsiveNavLink
